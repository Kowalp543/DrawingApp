package com.pl.agh.kowalp.drawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llPaint = findViewById(R.id.ll_paint_colors)
        mImageButtonCurrentPaint = llPaint[1] as ImageButton
        ...
        ibSave.setOnClickListener {
            if(isReadStorageAllowed()){
                BitmapAsyncTask(getBitmapFromView(fl)).execute()
            }else {
                requestStoragePermission()
            }
        }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if(requestCode == STORAGE_PERMISSION_CODE){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this, "Permission granted now you car read the storage files.", Toast.LENGTH_LONG).show()
            }else {
